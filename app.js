...
async function connect() {
    const urlQlikServer = "https://atonce-msp.eu.qlikcloud.com";
    const urlLoggedIn = "/api/v1/audits";//Use GET request to see if you are authenticated
    const urlLogin = "/login";
    const webIntegrationId = 'Dz94dfu7Xu80gGd2Lgl8hf8BewV7ZXcl';        
...
var config1 = {
    host: "atonce-msp.eu.qlikcloud.com", //the address of your Qlik Engine Instance
    ...
    webIntegrationId: 'Dz94dfu7Xu80gGd2Lgl8hf8BewV7ZXcl' //only needed in SaaS editions and QSEoK
};
...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp("8a167694-09fb-48fe-ac75-d670ffe70685", config1);
